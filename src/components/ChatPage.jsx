            ...
            selectedUser ? (
                <section className='flex-1 border-l border-l-gray-300 flex flex-col h-full'>
                    ...
                    <div className='flex items-center p-4 border-t border-t-gray-300'>
                        <Input value={textMessage} onChange={(e) => setTextMessage(e.target.value)} type= 'text' className='flex-1 mr-2 focus-visible:ring-transparent' placeholder='Type your Message..'/>
